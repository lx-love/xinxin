(function () {
    ...
    var stageDom = document.getElementById((window._mrmcp || {})['script_id'] || "Mugeda_5976e2c492b5790fec51126e")

    _mrmcp = (typeof _mrmcp == 'undefined') ? {} : _mrmcp;
_mrmcp['campaign_id'] = 'none';
_mrmcp['owner_id'] = '5976d95b92b5790ebf6e27e8';
_mrmcp['creative_id'] = '5976e2c492b5790fec51126e';
...
var version = _mrmcp['version'] = _mrmcp['version'] != null ? _mrmcp['version'] : '_0.10.31';
var w = _mrmcp['width'];
var h = _mrmcp['height'];
...
var loadProcessHandleInstance = Mugeda['loadProcessHandleInstance'] = new Mugeda['loadProcessHandle']['bar']({
    'loadInfo': JSON.parse("{\"textLoading\":0,\"messageText\":\"\",\"messageSize\":12,\"messageColor\":\"#FFF\",\"progressColor\":\"#F36523\",\"progressBackground\":\"#FFF\",\"backgroundColor\":\"#000\",\"backgroundImage\":null,\"logoImage\":null,\"progressPosition\":\"20\",\"logoWidth\":128,\"style\":\"bar\"}"),
    'thisAni': {
        'dom': null,
        'width': 320
    },
...
window['Mugeda']['Loader'] = function (dom, hasScript, _mrmcp) {
    ...
    if(!Mugeda['css3PlayerLoaded']) {
        ...
        loadRes(0, "mugeda_utils" + version + ".js", [0]);
        loadRes(1, that.crid + ".js?publishTime=1501080890541", []);
...
Mugeda.Loader.prototype.start = function () {
    if (2 == Mugeda.css3PlayerLoaded) {
        ...
        Mugeda['startAnimation']("id_" + this.crid, false ? "actions_" + this.crid + ".js?publishTime=1501080890541" : "", a, this.resDir, this.name, null, this._mrmcp)
    }
    else {
